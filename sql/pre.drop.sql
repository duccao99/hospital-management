...
DROP USER USER_TEPTAN_01;
DROP USER USER_TEPTAN_02;
...
BEGIN 
DBMS_RLS.DROP_POLICY('DUCCAO_ADMIN', 'HOSOBENHNHAN', 'FUNC_VPD_POLICY_DOCTOR_HOSOBENHNHAN'); 
END;


BEGIN 
DBMS_RLS.DROP_POLICY('DUCCAO_ADMIN', 'VIEW_VPD_DOCTOR_CTDONTHUOC', 'POLICY_VPD_DOCTOR_CTDONTHUOC'); 
END;
