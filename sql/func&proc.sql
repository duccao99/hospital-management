...
----------------------------------------------------------------------------------
-- 19. Procedure: All new patient records
-- Input:  
-- Output: 
--------------------------------------------------------------------------------
CREATE OR REPLACE PROCEDURE PROC_RECEPTION_ADD_NEW_PATIENT(
    IP_MAKB IN DUCCAO_ADMIN.VIEW_RECEPTION.MAKB%TYPE,
    IP_NGAYKB IN DUCCAO_ADMIN.VIEW_RECEPTION.NGAYKB%TYPE,    
    IP_MABN IN DUCCAO_ADMIN.VIEW_RECEPTION.MABN%TYPE,
    IP_HOTEN IN DUCCAO_ADMIN.VIEW_RECEPTION.HOTEN%TYPE,
    IP_TINHTRANGBANDAU IN DUCCAO_ADMIN.VIEW_RECEPTION.TINHTRANGBANDAU%TYPE,
    IP_BACSI_PHUTRACH IN DUCCAO_ADMIN.VIEW_RECEPTION.BACSI_PHUTRACH%TYPE,
...
INSERT INTO DUCCAO_ADMIN.VIEW_RECEPTION (MAKB, NGAYKB, MABN, HOTEN, TINHTRANGBANDAU, BACSI_PHUTRACH)
VALUES (IP_MAKB,IP_NGAYKB , IP_MABN, IP_HOTEN,IP_TINHTRANGBANDAU, IP_BACSI_PHUTRACH);
