...
CREATE OR REPLACE VIEW VW_DEP_LETAN_DICHVU
AS
SELECT MADV, TENDV
FROM DICHVU;

GRANT SELECT ON VW_DEP_LETAN_DICHVU TO ROLE_DEP_LETAN;

-- Test User Le Tan
CREATE USER USER_TEPTAN_01 IDENTIFIED BY USER_TEPTAN_01;
CREATE USER USER_TEPTAN_02 IDENTIFIED BY USER_TEPTAN_02;
GRANT CREATE SESSION TO USER_TEPTAN_01;
GRANT CREATE SESSION TO USER_TEPTAN_02;


GRANT ROLE_DEP_LETAN TO USER_TEPTAN_01;
GRANT ROLE_DEP_LETAN TO USER_TEPTAN_02;
...
--Grant policy to management department;
GRANT CREATE SESSION TO ROLE_DEP_QL_TG_NS;
...
-- Duoc quey xem tat ca thong tin cua nhan vien nhung khong duoc xem truong luong
CREATE OR REPLACE VIEW VW_DEP_QL_TAINGUYEN_NHANSU
AS
SELECT nv.MANV, nv.HOTEN, nv.LUONG, nv.NGAYSINH, nv.DIACHI, 
...
-- Test User Quan ly tai nguyen va nhan su
