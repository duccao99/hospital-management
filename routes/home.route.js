...
router.get(
  ...
  async function (req, res) {
    ...
    res.render('vwHome/AccountingDepartment', {
      layout: 'home.hbs',
      home_title: 'Accounting Department',
      curr_user_info: curr_user_info,
      chamcong_data
    });
  }
...
router.get('/home/user/role/doctor', async function (req, res) {
  const curr_user_info = req.session.authUser;

  const patient_info_data = await doctorModel.getViewDoctorSeePatientInfo(
    curr_user_info
  );
