...
values (1, 'Nguy?n Bình An', TO_DATE('12/01/1984', 'DD/MM/YYYY'),'4186 Ph? Quý, Xã ?ôn, Qu?n Kh?ng Thanh Thoa,H?i Phòng','0755586591');
insert into BENHNHAN (maBN, hoTen, ngaySinh, diaChi, sdt)
values (2, 'Trang Quang Tài', TO_DATE('12/01/1975', 'DD/MM/YYYY'),'093 Ph? Ông Khuyên Giác, Thôn Bành ?an, Huy?n Tr?ng Sang Ph?ng,C?n Th?','0755586592');
insert into BENHNHAN (maBN, hoTen, ngaySinh, diaChi, sdt) 
values (3, 'Nguy?n An Ninh', TO_DATE('12/01/1988', 'DD/MM/YYYY'),'115 Ph? Bùi Sang H?o, ?p Tu? Dung, Qu?n Lâm C??ng,S?n La','0755586593');
insert into BENHNHAN (maBN, hoTen, ngaySinh, diaChi, sdt) 
values (4, 'Nguy?n Thành Trung', TO_DATE('12/01/1983', 'DD/MM/YYYY'),'116 Ph? D? K? Khi?u, Xã Ch? Kim Tâm, Huy?n Hu?nh,Tây Ninh','0755586594');
insert into BENHNHAN (maBN, hoTen, ngaySinh, diaChi, sdt) 
values (5, 'Tr?n Minh Ki?t', TO_DATE('12/01/1972', 'DD/MM/YYYY'),'3376 Ph? Ti?p Trâm Ng?n, Ph??ng ?i?p Ph??ng, Qu?n Hu? H?u,C?n Th?','0755586595');
insert into BENHNHAN (maBN, hoTen, ngaySinh, diaChi, sdt) 
values (6, '?? Chính H?u', TO_DATE('12/01/1973', 'DD/MM/YYYY'),'48 Ph? M?, Ph??ng Trúc, Huy?n Hoán Mai,?à N?ng','0755586596');
insert into BENHNHAN (maBN, hoTen, ngaySinh, diaChi, sdt) 
values (7, 'Tr?m Công Lý', TO_DATE('12/01/1974', 'DD/MM/YYYY'),'2923, ?p Qu?nh, Ph??ng ??u Ki?n Lý, Huy?n Khôi,Ninh Thu?n','0755586597');
insert into BENHNHAN (maBN, hoTen, ngaySinh, diaChi, sdt)
values (8, 'Tr?n Tu?n Châu', TO_DATE('12/01/1981', 'DD/MM/YYYY'),'8387 Ph? Tôn Công Ki?n, Ph??ng Ph??c, Huy?n Xa Hoán,B?n Tre','0755586598');
insert into BENHNHAN (maBN, hoTen, ngaySinh, diaChi, sdt) 
values (9, 'V? Trung Nhân', TO_DATE('12/01/1969', 'DD/MM/YYYY'),'6545 Ph? Xuân, Ph??ng Th?o Bì, Qu?n Nghi?p Cát,Bà R?a - V?ng Tàu','0755586599');
insert into BENHNHAN (maBN, hoTen, ngaySinh, diaChi, sdt) 
values (10, 'Nguy?n Tr?ng Vinh', TO_DATE('12/01/1960', 'DD/MM/YYYY'),'8, Thôn Th?nh, Xã Chinh, Qu?n Trang,Bình ??nh','0755586511');

--insert Don vi
insert into DONVI (maDonVi, tenDonVi) 
values (1,'B? ph?n qu?n lý');
insert into DONVI (maDonVi, tenDonVi) 
values (2,'B? ph?n ti?p tân và ?i?u ph?i b?nh');
insert into DONVI (maDonVi, tenDonVi) 
values (3,'Bác s?');
insert into DONVI (maDonVi, tenDonVi) 
values (4,'Phòng tài v?');
insert into DONVI (maDonVi, tenDonVi) 
values (5,'Phòng bán thu?c');
insert into DONVI (maDonVi, tenDonVi) 
values (6,'B? ph?n k? toán');

--insert NHANVIEN
insert into NHANVIEN (maNV, hoTen, luong, ngaySinh, diaChi, vaiTro, maDonVi) 
values (1,'??ng Ng?c Ph?ng',6912000,TO_DATE('12/01/1960', 'DD/MM/YYYY'),'3102 Ph? Yên, Xã H?a, Huy?n 38, Bình Thu?n','vaitro',1);
insert into NHANVIEN (maNV, hoTen, luong, ngaySinh, diaChi, vaiTro, maDonVi) 
values (2,'T?ng H??ng Ly',6912000,TO_DATE('12/01/1960', 'DD/MM/YYYY'),'905 Ph? Anh, Xã Tri?t ?àm, Huy?n Khu?t Xuân, H? Chí Minh','vaitro',1);
insert into NHANVIEN (maNV, hoTen, luong, ngaySinh, diaChi, vaiTro, maDonVi) 
values (3,'D??ng Vân Khánh',6912000,TO_DATE('12/01/1960', 'DD/MM/YYYY'),'0018, ?p Bình Dinh, Ph??ng ?ình Mang, Qu?n Trà, Long An','vaitro',2);
insert into NHANVIEN (maNV, hoTen, luong, ngaySinh, diaChi, vaiTro, maDonVi) 
values (4,'Ch? H?o Nhi',6912000,TO_DATE('12/01/1960', 'DD/MM/YYYY'),'316 Ph? Xa Khang Nhiên, Xã 27, Qu?n ???ng ??i, Tây Ninh','vaitro',3);
insert into NHANVIEN (maNV, hoTen, luong, ngaySinh, diaChi, vaiTro, maDonVi) 
values (5,'Ngô H?nh Dung',6912000,TO_DATE('12/01/1960', 'DD/MM/YYYY'),'5, Thôn 3, Thôn Ki?u Tú, Qu?n B?ch, V?nh Phúc','vaitro',2);
insert into NHANVIEN (maNV, hoTen, luong, ngaySinh, diaChi, vaiTro, maDonVi) 
values (6,'U?t Khánh Minh',12800000,TO_DATE('12/01/1960', 'DD/MM/YYYY'),'683, ?p Dao Cù, Xã 1, Qu?n Ninh ,Khánh Hòa','vaitro',3);
insert into NHANVIEN (maNV, hoTen, luong, ngaySinh, diaChi, vaiTro, maDonVi) 
values (7,'V?n Ð?c Duy',6912000,TO_DATE('12/01/1960', 'DD/MM/YYYY'),'01, Thôn Hân, Ph??ng Kh??ng, Huy?n T?ng ,Kon Tum','vaitro',4);
insert into NHANVIEN (maNV, hoTen, luong, ngaySinh, diaChi, vaiTro, maDonVi) 
values (8,'Hoàng Lâm Viên',6912000,TO_DATE('12/01/1960', 'DD/MM/YYYY'),'8, ?p Khanh Ngân, Ph??ng Nhiên, Huy?n 95 ,Ninh Thu?n','vaitro',5);
insert into NHANVIEN (maNV, hoTen, luong, ngaySinh, diaChi, vaiTro, maDonVi) 
values (9,'Chung Uy V?',6912000,TO_DATE('12/01/1960', 'DD/MM/YYYY'),'148 Ph? Khu?t Khoa M?n, Xã Th?c, Huy?n Trinh Danh ,Cà Mau','vaitro',6);
insert into NHANVIEN (maNV, hoTen, luong, ngaySinh, diaChi, vaiTro, maDonVi)
values (10,'Tr??ng Quang Th?ng',6912000,TO_DATE('12/01/1960', 'DD/MM/YYYY'),'45 Ph? Trà, Xã T??ng ??i, Qu?n Oanh H?c, C?n Th?','vaitro',6);
...
values (1,'TITANIUM DIOXIDE','Viên','16.200','Không t? ý ng?ng ho?c t?ng li?u');
insert into THUOC (maThuoc,tenThuoc, donViThuoc, donGia, luuY)
values (2,'Clotrimazole 1%','Viên','5.200','Không t? ý ng?ng ho?c t?ng li?u');
insert into THUOC (maThuoc,tenThuoc, donViThuoc, donGia, luuY)
values (3,'Levofloxacin','Viên','5.260','Không t? ý ng?ng ho?c t?ng li?u');
insert into THUOC (maThuoc,tenThuoc, donViThuoc, donGia, luuY)
values (4,'Povidone Iodine','Viên','134.400','Không t? ý ng?ng ho?c t?ng li?u');
insert into THUOC (maThuoc,tenThuoc, donViThuoc, donGia, luuY)
values (5,'DEXTROSE','Chai','16.200','Không t? ý ng?ng ho?c t?ng li?u');
insert into THUOC (maThuoc,tenThuoc, donViThuoc, donGia, luuY)
values (6,'ENALAPRIL MALEATE','Viên','8.000','Không t? ý ng?ng ho?c t?ng li?u');
insert into THUOC (maThuoc,tenThuoc, donViThuoc, donGia, luuY)
values (7,'Hydroxychloroquine Sulfate','Chai','6.700','Không t? ý ng?ng ho?c t?ng li?u');
insert into THUOC (maThuoc,tenThuoc, donViThuoc, donGia, luuY)
values (8,'Imipramine Hydrochloride','Chai','26.500','Không t? ý ng?ng ho?c t?ng li?u');
insert into THUOC (maThuoc,tenThuoc, donViThuoc, donGia, luuY)
values (9,'Benzalkonium Chloride, Lidocaine Hydrochloride','Viên','39.000','Không t? ý ng?ng ho?c t?ng li?u');
insert into THUOC (maThuoc,tenThuoc, donViThuoc, donGia, luuY)
values (10,'Hydroxyzine Pamoate','Viên','3.000','Không t? ý ng?ng ho?c t?ng li?u');
...
insert into HOSOBENHNHAN (maKB,ngayKB, maNV, maBN, tinhTrangBanDau, ketLuanCuaBacSi)
values (4,TO_DATE('12/01/2020', 'DD/MM/YYYY'),6,5,'?au b?ng bên ph?i','ketLuanCuaBacSi');
insert into HOSOBENHNHAN (maKB,ngayKB, maNV, maBN, tinhTrangBanDau, ketLuanCuaBacSi)
values (5,TO_DATE('12/01/2020', 'DD/MM/YYYY'),6,6,'?au c? chân','ketLuanCuaBacSi');
insert into HOSOBENHNHAN (maKB,ngayKB, maNV, maBN, tinhTrangBanDau, ketLuanCuaBacSi)
values (6,TO_DATE('12/01/2020', 'DD/MM/YYYY'),6,7,'S?t cao','ketLuanCuaBacSi');
insert into HOSOBENHNHAN (maKB,ngayKB, maNV, maBN, tinhTrangBanDau, ketLuanCuaBacSi)
values (7,TO_DATE('12/01/2020', 'DD/MM/YYYY'),4,8,'S?t cao và ho','ketLuanCuaBacSi');
insert into HOSOBENHNHAN (maKB,ngayKB, maNV, maBN, tinhTrangBanDau, ketLuanCuaBacSi)
...
insert into DONTHUOC (maKB,nhanVienPhuTrach)
values (2,'Nguy?n ??c Trình');
insert into DONTHUOC (maKB,nhanVienPhuTrach)
values (3,'Nguy?n V?n Lâm');
insert into DONTHUOC (maKB,nhanVienPhuTrach)
...
values (1,'Siêu âm 2D','150.000');
insert into DICHVU (maDV, tenDV, donGia)
values (2,'Siêu âm 3D','250.000');
insert into DICHVU (maDV, tenDV, donGia)
values (3,'Khám, n?i soi Tai, M?i, H?ng','230.000');
insert into DICHVU (maDV, tenDV, donGia)
values (4,'Khám s? sinh','150.000');
insert into DICHVU (maDV, tenDV, donGia)
values (5,'Chi?u b?ng máy plasmamend h? tr? ?i?u tr? v?t th??ng','240.000');
insert into DICHVU (maDV, tenDV, donGia)
values (6,'Sàng l?c thính l? s? sinh','200.000');
insert into DICHVU (maDV, tenDV, donGia)
values (7,'T?m khô','300.000');
insert into DICHVU (maDV, tenDV, donGia)
values (8,'D?ch v? massage s? sinh','150.000');
insert into DICHVU (maDV, tenDV, donGia)
values (9,'Gi?m ?au th? thu?t','1.000.000');
insert into DICHVU (maDV, tenDV, donGia)
values (10,'Theo dõi chuy?n d? và ?? ?é','1.000.000');
